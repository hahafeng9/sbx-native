...
const UUID           = process.env.UUID           || '40dd1983-0c1a-4178-83bb-8adc28dc078f'; // UUID，运行哪吒请修改
...
const ARGO_DOMAIN    = process.env.ARGO_DOMAIN    || 'eyJhIjoiNjVmMDUzZTNjYzM4Y2JiNTgwZWJlYjM3YTQzMzU4NWMiLCJ0IjoiYjJjYTk1YzQtNDdmNi00YmJhLTkxMzUtZTllNjRjNGFmYjgxIiwicyI6Ik16ZGtNV1k1WldVdFpXUmpPUzAwTmpNMUxXRTJaRFV0TjJZek1EZzNNelprTXpJMiJ9';         // argo固定隧道域名,留空即使用临时隧道
const ARGO_AUTH      = process.env.ARGO_AUTH      || 'slimens.5785787.xyz';         // argo固定隧道token或json,留空即使用临时隧道
